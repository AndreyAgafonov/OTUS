...
2. Загрузиться с LiveCD  в Troubleshooting - Rescue a CentOS system, смонтировать файловую "/" систему на запись  и изменить пароль "passwd".
...
1. Установил CentOS 7 с образа и создал раздел /home  c типом LVM
...
При перезагрузке видим нашего  Tux-а
